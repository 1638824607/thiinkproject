...
<head>
    ...
    <link rel="stylesheet" href="{{asset('resources/views/home/css/ch-ui.admin.css')}}">
    <link rel="stylesheet" href="{{asset('resources/views/home/font/css/font-awesome.min.css')}}">
