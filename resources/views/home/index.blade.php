...
@section('info')
    ...
    <meta name="keywords" content="个人博客PHP技术分享" />
    <meta name="description" content="个人博客PHP技术分享" />
@endsection
@section('content')
<div class="banner">
    <section class="box">
        ...
        <div class="avatar"><a href="#"><span>沈如祥</span></a> </div>
    </section>
</div>
<div class="template">
    <div class="box">
        <h3>
            <p><span>博客</span>推荐 Recommend</p>
        </h3>
        <ul>
            @foreach($pics as $p)
...
<article>
    ...
    <div class="bloglist left">
        ...
        <p class="dateview"><span>　{{date('Y-m-d',$d->art_time)}}</span><span>{{$d->art_editor}}</span><span>个人博客：[<a href="{{url('/cate/'.$d->cate_id)}}">{{$d->cate_name}}</a>]</span></p>
        @endforeach
        <div class="page">
            {{$data->links()}}
        </div>
