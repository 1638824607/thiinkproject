...
@section('content')
    ...
    <div class="crumb_warp">
        <i class="fa fa-home"></i> <a href="{{'admin/info'}}">首页</a> &raquo;文章管理
    </div>
    <!--面包屑导航 结束-->
	<!--结果集标题与导航组件 开始-->
            ...
            <table class="add_tab">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="lg" name="art_title" maxlength="30">
                            <p>标题可以写30个字</p>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th>文章缩略图：</th>
                        <td>
                            <input type="text" size="50" class="lg" name="art_thumb">
