		...
		<ul>
			<li>
				...
				<ul class="sub_menu">
					...
					<li><a href="{{url('admin/article/search')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>文章列表</a></li>
					<li><a href="{{url('admin/mes')}}" target="main"><i class="fa fa-fw fa-list-ul"></i>留言板列表</a></li>
				</ul>
			</li>
			<li>
				...
				<ul class="sub_menu" style="display: block">
					...
					<li><a href="{{url('admin/root')}}" target="main"><i class="fa fa-fw fa-ra"></i>管理员设置</a></li>
